...
void Bakelite::LoadGfeSDK() {
	...
	if (!hGetProcIDDLL) {
		...
		cvarManager->log("Loaded GfeSDK.dll");
	}
	NVGSDK_Create =
		(NVGSDK_Createfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_Create");
	NVGSDK_Release =
		(NVGSDK_Releasefn)GetProcAddress(hGetProcIDDLL, "NVGSDK_Release");
	NVGSDK_Poll =
		(NVGSDK_Pollfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_Poll");
	NVGSDK_SetLogLevel =
		(NVGSDK_SetLogLevelfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_SetLogLevel");
	NVGSDK_AttachLogListener =
		(NVGSDK_AttachLogListenerfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_AttachLogListener");
	NVGSDK_SetListenerLogLevel =
		(NVGSDK_SetListenerLogLevelfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_SetListenerLogLevel");
	NVGSDK_RequestPermissionsAsync =
		(NVGSDK_RequestPermissionsAsyncfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_RequestPermissionsAsync");
	NVGSDK_GetUILanguageAsync =
		(NVGSDK_GetUILanguageAsyncfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_GetUILanguageAsync");
	NVGSDK_Highlights_ConfigureAsync =
		(NVGSDK_Highlights_ConfigureAsyncfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_Highlights_ConfigureAsync");
	NVGSDK_Highlights_GetUserSettingsAsync =
		(NVGSDK_Highlights_GetUserSettingsAsyncfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_Highlights_GetUserSettingsAsync");
	...
	NVGSDK_Highlights_SetVideoHighlightAsync =
		(NVGSDK_Highlights_SetVideoHighlightAsyncfn)GetProcAddress(hGetProcIDDLL, "NVGSDK_Highlights_SetVideoHighlightAsync");
